...
只返回这个格式，不要加号不要解释。\n\n对话：\n${text}` }
  ...
  _getLocalQuote() {
    const quotes = [
      ...
      // 心理学
      { book: '《被讨厌的勇气》', author: '岸见一郎 / 古贺史健', quote: '重要的不是被给予了什么，而是如何去利用被给予的东西。' },
      { book: '《自卑与超越》', author: '阿德勒', quote: '我们生活在与他人的联系之中，假如因自卑而将自己孤立，必将自取灭亡。' },
      { book: '《少有人走的路》', author: 'M·斯科特·派克', quote: '人生苦难重重。这是个伟大的真理，一旦领悟，就能实现人生的超越。' },
      { book: '《非暴力沟通》', author: '马歇尔·卢森堡', quote: '当我们褪去隐蔽的精神暴力，爱将自然流露。' },
      ...
      { book: '《影响力》', author: '罗伯特·西奥迪尼', quote: '我们在要别人帮忙的时候，要是能给一个理由，成功的概率会更大。' },
      { book: '《自卑与超越》', author: '阿德勒', quote: '生活的意义在于对别人发生兴趣以及互助合作。' },
      { book: '《也许你该找个人聊聊》', author: '洛莉·戈特利布', quote: '我们无法改变过去，但可以改变对过去的理解。' },
      { book: '《当下的力量》', author: '埃克哈特·托利', quote: '你无法在过去或未来找到自己，唯一能找到自己的时刻就是当下。' },
