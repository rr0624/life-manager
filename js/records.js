...
只返回这个格式，不要加号不要解释。\n\n对话：\n${text}` }
  ...
  _getLocalQuote() {
    const quotes = [
      ...
      // 心理学与哲学
      { book: '《梦的解析》', author: '弗洛伊德', quote: '梦是愿望的满足。' },
      { book: '《精神分析引论》', author: '弗洛伊德', quote: '无意识才是真正的精神现实。' },
      { book: '《自卑与超越》', author: '阿德勒', quote: '我们生活在与他人的联系之中，假如因自卑而将自己孤立，必将自取灭亡。' },
      { book: '《寻求灵魂的现代人》', author: '荣格', quote: '只有在我们审视自己的内心时，视野才会变得清晰。' },
      { book: '《逃避自由》', author: '埃里希·弗洛姆', quote: '现代人虽然摆脱了传统的束缚，却没有获得积极的自由。' },
      { book: '《爱的艺术》', author: '埃里希·弗洛姆', quote: '爱不是一种感觉，而是一种能力，需要知识和努力。' },
      { book: '《动机与人格》', author: '亚伯拉罕·马斯洛', quote: '一个人能成为什么，他就必须成为什么。' },
      { book: '《思考，快与慢》', author: '丹尼尔·卡尼曼', quote: '我们对自己认为知道的，总是过于自信。' },
      { book: '《心流》', author: '米哈里·契克森米哈赖', quote: '最好的时刻通常发生在一个人为了某项艰巨的任务而辛苦付出，把体能和智力都发挥到极致的时候。' },
      { book: '《乌合之众》', author: '古斯塔夫·勒庞', quote: '群体中的个人，不过是众多沙粒中的一颗，可以被风吹到任何地方。' },
      { book: '《社会性动物》', author: '艾略特·阿伦森', quote: '人类是社会性动物，我们最深的幸福来自与他人的连接。' },
      { book: '《存在与虚无》', author: '萨特', quote: '人是自由的，人注定自由，人背负着自由的重量。' },
      { book: '《存在与时间》', author: '海德格尔', quote: '人是一种向死而生的存在。' },
      { book: '《规训与惩罚》', author: '米歇尔·福柯', quote: '权力不是被占有的，而是被行使的。' },
      { book: '《查拉图斯特拉如是说》', author: '尼采', quote: '人是一根绳索，架在超人与野兽之间。' },
      { book: '《西西弗神话》', author: '加缪', quote: '必须想象西西弗是幸福的。' },
    ];
